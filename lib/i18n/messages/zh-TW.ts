...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.dictationSettings": "聽寫設定",
    "chat.dictationDevice": "麥克風",
    "chat.dictationModel": "模型",
    "chat.dictationWarmingUp": "正在載入模型…",
    "chat.dictationTranscribing": "正在轉寫…",
    "chat.liveStart": "開始即時對話",
    "chat.liveStop": "停止即時對話",
    "chat.liveInterrupt": "打斷並接管發言",
    "chat.liveInterruptShort": "打斷",
