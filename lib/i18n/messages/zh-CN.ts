...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.dictationDevice": "麦克风",
    "chat.dictationModel": "模型",
    "chat.dictationWarmingUp": "正在加载模型…",
    "chat.dictationTranscribing": "正在转写…",
    "chat.liveStart": "开始实时对话",
    "chat.liveStop": "停止实时对话",
    "chat.liveInterrupt": "打断并接管发言",
    "chat.liveInterruptShort": "打断",
