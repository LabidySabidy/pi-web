...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.dictationDevice": "Microphone",
    "chat.dictationModel": "Model",
    "chat.dictationWarmingUp": "Loading model…",
    "chat.dictationTranscribing": "Transcribing…",
    "chat.liveStart": "Start live conversation",
    "chat.liveStop": "Stop live conversation",
    "chat.liveInterrupt": "Interrupt and take the floor",
    "chat.liveInterruptShort": "Interrupt",
